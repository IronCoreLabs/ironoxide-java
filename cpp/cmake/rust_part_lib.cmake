...
set(RUST_BUILD_CWD "${ROOT_DIR}")

function (find_cargo_target_directory CACHEVAR)
  if (DEFINED ${CACHEVAR})
    message(STATUS "Cached target path: ${${CACHEVAR}}")
    return ()
  endif ()
...
set(RUST_SWIG_SRCS "${RUST_BUILD_CWD}/src/lib.rs.in")
...
if (WIN32)
  set(RUST_PART_LIB_NAME "libironoxid_shared.dll.lib")
elseif (${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
  set(RUST_PART_LIB_NAME "libironoxid_shared.dylib")
else ()
  set(RUST_PART_LIB_NAME "libironoxid_shared.so")
endif ()
